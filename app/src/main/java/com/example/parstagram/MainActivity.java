...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCaptureImageButton = findViewById(R.id.btnCaptureImage);
        mPostImageView = findViewById(R.id.ivPostImage);
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(MainActivity.this, "com.codepath.fileprovider.mishka-parstagram", mPhotoFile);
    ...
    public File getPhotoFileUri(String fileName) {
        ...
        File mediaStorageDir = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), sTAG);
